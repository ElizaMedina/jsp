        ...
        <div class="modal-body">
             <form action="sr_estudiante" method="post" class="form-group">
               <label for="lbl_id" ><b>ID</b></label>
                ...
                <label for="lbl_telefono" ><b>Correo_Electronico</b></label>
                <input type="e-mail" name="txt_email" id="txt_telefono" class="form-control" placeholder="Ejemplo: umg@umg.com" required>
                <label for="lbl_puesto" ><b>Tipo_Sangre</b></label>
                <select name="drop_puesto" id="drop_puesto" class="form-control">
                    <% 
                        Tipo_Sangre tsangre = new sangre();
...
<script type="text/javascript">
    function limpiar(){
       ...
       $("#txt_fehca_nacimiento").val('');
       
    }
   
    $('#tbl_estudiantes').on('click','tr td',function(evt){
       var target,id,id_tipo_sangre,carnet,nombres,apellidos,direccion,telefono,correo_electronico,nacimiento,; 
       target = $(event.target);
